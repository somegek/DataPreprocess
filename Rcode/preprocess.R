...
UNEM <- UNEM[TIME_PERIOD >= "1999 Q3"]
UNEM <- UNEM[TIME_PERIOD <= "2018 Q2"]
...
HICP <- HICP[TIME_PERIOD >= "1999 Q3"]
HICP <- HICP[TIME_PERIOD <= "2018 Q2"]
...
rm(e,ei,ej,tempCov,tempDT,amountOfForecasters,covName,forcastersList,horz,i,j,time,topic)
