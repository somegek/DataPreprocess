getForecast <- function(DT){
  # this function loads the weight and produce the weighted mean as the forecast value in a new column
  ...
  # take 1 value per test period, discarding individual forecasts
